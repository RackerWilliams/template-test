...
class TemplateTestSpec extends BaseWADLSpec {
  ...
  feature ("Remove link components") {
    scenario ("from element based on an index") {
      ...
      TemplateTest.updateLinks(List("foo:link"), Map("foo" -> "http://www.foo.com/foo"),
                               Some(1), /* index */
                               None,    /* URI marker */
                               None,    /* new Component */
                               false,   /* Fail on miss */
    ...
    scenario ("from attribute based on an index") {
      ...
      TemplateTest.updateLinks(List("foo:link/@href"), Map("foo" -> "http://www.foo.com/foo"),
                               Some(1), /* index */
                               None,    /* URI marker */
                               None,    /* new Component */
                               false,   /* Fail on miss */
    ...
    scenario ("from element and attribute based on an index") {
      ...
      TemplateTest.updateLinks(List("foo:link|foo:link/@href"), Map("foo" -> "http://www.foo.com/foo"),
                               Some(1), /* index */
                               None,    /* URI marker */
                               None,    /* new Component */
                               false,   /* Fail on miss */
    ...
    scenario ("from element and attribute (seperate xpaths) based on an index") {
      val inInput = <foo xmlns="http://www.foo.com/foo">
           <baz />
           <biz />
           <link href="http://www.rackspace.com/v1.0/37778/path/to/widget">http://www.rackspace.com/v1.0/37778/path/to/widget</link>
    ...
    scenario ("from element and attribute (seperate xpaths) based on a marker") {
      val inInput = <foo xmlns="http://www.foo.com/foo">
           <baz />
           <biz />
           <link href="http://www.rackspace.com/v1.0/37778/path/to/widget">http://www.rackspace.com/v1.0/37778/path/to/widget</link>
  ...
  feature ("Add link components") {
    ...
    scenario ("from element and attribute (seprate xpaths) based on an index") {
      val inInput = <foo xmlns="http://www.foo.com/foo">
           <baz />
           <biz />
           <link href="http://www.rackspace.com/v1.0/path/to/widget">http://www.rackspace.com/v1.0/path/to/widget</link>
  ...
  feature ("fail on miss") {
    scenario ("should not fail on miss if feature not set") {
      ...
      TemplateTest.updateLinks(List("foo:missit"), Map("foo" -> "http://www.foo.com/foo"),
                               Some(1), /* index */
                               None,    /* URI marker */
                               None,    /* new Component */
                               false,   /* Fail on miss */
    ...
    scenario ("should fail on miss if feature is set") {
      ...
      assert (thrown.getMessage() == "Could not match on XPATH(s) \"foo:missit\"")
    }

    scenario ("should fail on miss if feature is set (some match)") {
      val inInput = <foo xmlns="http://www.foo.com/foo">
           <baz />
           <biz />
           <link>http://www.rackspace.com/v1.0/37778/path/to/widget</link>
      ...
      val thrown = intercept[Exception] {
      TemplateTest.updateLinks(List("foo:link","foo:missit"), Map("foo" -> "http://www.foo.com/foo"),
                               Some(1), /* index */
                               None,    /* URI marker */
                               None,    /* new Component */
                               true,   /* Fail on miss */
    ...
    scenario ("should fail on miss if feature is set (some match, multi-fail)") {
      val inInput = <foo xmlns="http://www.foo.com/foo">
           <baz />
           <biz />
           <link>http://www.rackspace.com/v1.0/37778/path/to/widget</link>
      ...
      val thrown = intercept[Exception] {
      TemplateTest.updateLinks(List("foo:link","foo:missit", "foo:missit2"), Map("foo" -> "http://www.foo.com/foo"),
                               Some(1), /* index */
                               None,    /* URI marker */
                               None,    /* new Component */
                               true,   /* Fail on miss */
      ...
      assert (thrown.getMessage() == "Could not match on XPATH(s) \"foo:missit\", \"foo:missit2\"")
    }
  }
